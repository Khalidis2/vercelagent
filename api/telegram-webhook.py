...
def h_add_income(svc, d, chat_id, user_name, user_id):
    ...
    # log to pending for traceability
...
def h_sell_livestock(svc, d, chat_id, user_name, user_id):
    ...
    elif price and is_slaughter:
        # optional: record value of slaughter as internal use
        pass
...
def h_category_total(data, d, chat_id):
    ...
    send(chat_id, f"📊 {cat} ({label}): {fmt(total)} د.إ")
